...
#pragma warning( disable:4312 )  // 'type cast' : conversion from 'LONG' to 'HANDLE' of greater size
#pragma warning( disable:4133 )  // 'function' : incompatible types - from 'char *' to 'LPCWSTR'
