...
complist_delete(COMPLIST cl)
{
        ...
        List_TRAVERSE_M(cl->items, item, COMPITEM) {
        ...
        rhead = dir_getroot_list(cl->right);
{
         ...
         */
        List_TRAVERSE_M(cl->items, ci, COMPITEM) {
...
complist_dodlg_savelist(HWND hDlg, UINT message, UINT wParam, long lParam)
{
        ...
        case WM_INITDIALOG:
                ...
                SendDlgItemMessage(hDlg, IDD_LEFT, WM_SETTEXT, 0, (LPARAM) (LPSTR) buffer);
                /* convert 'right tree' msg into correct path */
                wsprintf((LPTSTR)buffer, LoadRcString(IDS_FILES_ONLY), (LPSTR) dialog_rightname);
                SendDlgItemMessage(hDlg, IDD_RIGHT, WM_SETTEXT, 0, (LPARAM) (LPSTR) buffer);
...
complist_dodlg_dir(HWND hDlg, unsigned message, WORD wParam, LONG lParam)
{
        ...
        case WM_COMMAND:
                ...
                case IDOK:
                        ...
                        dlg_recursive = (BOOL)SendDlgItemMessage(hDlg, IDD_RECURSIVE,
                                BM_GETCHECK, 0, 0);
