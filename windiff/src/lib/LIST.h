...
#define _LIST_H_
  ...
  */
  ...
  #define List_TRAVERSE(lst, curs)  for(  curs = (SECTION)List_First(lst)         \
                                       ;  curs != NULL                            \
                                       ;  curs = (SECTION)List_Next((LPVOID)curs) \
                                       )
  
  #define List_TRAVERSE_L(lst, curs)  for(  curs = (LINE)List_First(lst)        \
                                       ;  curs != NULL                         \
                                       ;  curs = (LINE)List_Next((LPVOID)curs) \
                                       )

  #define List_TRAVERSE_D(lst, curs)  for(  curs = (DIRECT)List_First(lst)        \
                                       ;  curs != NULL                         \
                                       ;  curs = (DIRECT)List_Next((LPVOID)curs) \
                                       )

  #define List_TRAVERSE_M(lst, curs, cast)  for(  curs = (cast)List_First(lst) \
                                       ;  curs != NULL                         \
                                       ;  curs = (cast)List_Next((LPVOID)curs) \
                                       )
