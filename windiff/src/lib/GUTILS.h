...
extern BOOL APIENTRY DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID reserved);

HWND APIENTRY StatusCreate(HINSTANCE hInst, HWND hParent, int id,
